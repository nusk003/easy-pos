...
export const PointsOfInterestCatalogCategorySidebar: React.FC = () => {
  const { sidebar, setSidebar, updateCategory } = usePointsOfInterestStore(
    useCallback(
      (state) => ({
        sidebar: state.pointsOfInterestCategorySidebar,
        setSidebar: state.setPointsOfInterestCategorySidebar,
